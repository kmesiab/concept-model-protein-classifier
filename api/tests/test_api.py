...
class TestClassifyEndpoint:
    ...
    def test_classify_with_custom_threshold(self, client, headers):
        ...
        request_data = {
            "sequences": [{"id": "test1", "sequence": "MKVLWAASLLLLASAARA"}],
            "threshold": 5,
        }
    ...
    def test_empty_sequence(self, client, headers):
        ...
        request_data = {"sequences": [{"id": "test1", "sequence": ""}]}
    ...
    def test_feature_values(self, client, headers):
        ...
        request_data = {"sequences": [{"id": "test1", "sequence": "ACDEFGHIKLMNPQRSTVWY"}]}
...
class TestPerformance:
    ...
    def test_batch_processing_speed(self, client, headers):
        ...
        sequences = [{"id": f"seq{i}", "sequence": "ACDEFGHIKLMNPQRSTVWY" * 2} for i in range(50)]
        request_data = {"sequences": sequences}
    ...
    def test_single_sequence_speed(self, client, headers):
        ...
        request_data = {"sequences": [{"id": "test1", "sequence": "ACDEFGHIKLMNPQRSTVWY" * 5}]}
